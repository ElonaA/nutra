...
const Modal = ({active, setActiv}) => {
    return (
      <div className={active ? "modal__wrapper active" : "modal__wrapper"} onClick={() => setActiv(false)}>
      <div className="form__wrapper" onClick={e => e.stopPropagation()}>
        ...
        <div className="form__container">
          <div className="left">
              <h2 className="form__title">Fill out the fields bellow to recive prodduct</h2>
              <form className="form">
                  <label className="form__label" for="name">Name</label>
                  <input name="name" id="name" className="form__input" placeholder="Enter your name" required></input>

                  <label className="form__label" for="phone">Phone</label>
                  <input name="phone" id="phone" className="form__input" placeholder="Enter your phone" required></input>
